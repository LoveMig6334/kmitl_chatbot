/*
 * Google's brand mark. The four colours are mandated by Google's sign-in branding
 * guidelines and are the only literal colour values allowed outside globals.css
 * (the design-token test exempts components/icons/).
 */
